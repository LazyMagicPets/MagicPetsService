...
namespace ChatSchema
{
    ...
    public partial class ListChatsResponse : System.ComponentModel.INotifyPropertyChanged
    {
        private System.Collections.Generic.ICollection<Chat> _chats = new System.Collections.ObjectModel.Collection<Chat>();
        private ChatPaginationInfo _pagination = new ChatPaginationInfo();

        [Newtonsoft.Json.JsonProperty("chats", Required = Newtonsoft.Json.Required.Always)]
        public System.Collections.Generic.ICollection<Chat> Chats
        {
            get { return _chats; }
        ...
        public ChatPaginationInfo Pagination
        {
