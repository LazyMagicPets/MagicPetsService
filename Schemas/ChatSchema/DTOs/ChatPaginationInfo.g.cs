...
namespace ChatSchema
{
    ...
    public partial class ChatPaginationInfo : System.ComponentModel.INotifyPropertyChanged
    {
        private int _page;
        private int _limit;
        private int _totalChats;
        ...
        [Newtonsoft.Json.JsonProperty("totalChats", Required = Newtonsoft.Json.Required.Always)]
        public int TotalChats
        {
            get { return _totalChats; }

            set
            {
                if (_totalChats != value)
                {
                    _totalChats = value;
                    RaisePropertyChanged();
                }
