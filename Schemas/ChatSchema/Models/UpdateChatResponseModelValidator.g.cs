...
public partial class UpdateChatResponseModelValidator : FluentValidation.AbstractValidator<UpdateChatResponseModel>
{
    public UpdateChatResponseModelValidator()
    {
        Include(new UpdateChatResponseValidator());
        CustomValidation();
    }
