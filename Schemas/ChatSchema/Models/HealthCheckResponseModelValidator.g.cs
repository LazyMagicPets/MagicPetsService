...
public partial class HealthCheckResponseModelValidator : FluentValidation.AbstractValidator<HealthCheckResponseModel>
{
    public HealthCheckResponseModelValidator()
    {
        Include(new HealthCheckResponseValidator());
        CustomValidation();
    }
