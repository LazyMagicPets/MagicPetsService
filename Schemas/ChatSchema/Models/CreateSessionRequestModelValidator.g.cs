...
public partial class CreateSessionRequestModelValidator : FluentValidation.AbstractValidator<CreateSessionRequestModel>
{
    public CreateSessionRequestModelValidator()
    {
        Include(new CreateSessionRequestValidator());
        CustomValidation();
    }
