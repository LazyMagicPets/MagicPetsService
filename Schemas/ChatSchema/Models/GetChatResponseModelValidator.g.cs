...
public partial class GetChatResponseModelValidator : FluentValidation.AbstractValidator<GetChatResponseModel>
{
    public GetChatResponseModelValidator()
    {
        Include(new GetChatResponseValidator());
        CustomValidation();
    }
