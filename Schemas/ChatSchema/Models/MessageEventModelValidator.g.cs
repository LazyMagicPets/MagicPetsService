...
public partial class MessageEventModelValidator : FluentValidation.AbstractValidator<MessageEventModel>
{
    public MessageEventModelValidator()
    {
        Include(new MessageEventValidator());
        CustomValidation();
    }
