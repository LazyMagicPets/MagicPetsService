...
public partial class ChatMessageModelValidator : FluentValidation.AbstractValidator<ChatMessageModel>
{
    public ChatMessageModelValidator()
    {
        Include(new ChatMessageValidator());
        CustomValidation();
    }
