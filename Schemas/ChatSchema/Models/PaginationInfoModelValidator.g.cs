...
public partial class PaginationInfoModelValidator : FluentValidation.AbstractValidator<PaginationInfoModel>
{
    public PaginationInfoModelValidator()
    {
        Include(new PaginationInfoValidator());
        CustomValidation();
    }
