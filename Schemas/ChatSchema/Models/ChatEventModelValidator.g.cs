...
public partial class ChatEventModelValidator : FluentValidation.AbstractValidator<ChatEventModel>
{
    public ChatEventModelValidator()
    {
        Include(new ChatEventValidator());
        CustomValidation();
    }
