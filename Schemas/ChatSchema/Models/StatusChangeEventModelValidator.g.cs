...
public partial class StatusChangeEventModelValidator : FluentValidation.AbstractValidator<StatusChangeEventModel>
{
    public StatusChangeEventModelValidator()
    {
        Include(new StatusChangeEventValidator());
        CustomValidation();
    }
