...
public partial class ChatPaginationInfoModelValidator : FluentValidation.AbstractValidator<ChatPaginationInfoModel>
{
    public ChatPaginationInfoModelValidator()
    {
        Include(new ChatPaginationInfoValidator());
        CustomValidation();
    }
