...
public partial class ChatSessionModelValidator : FluentValidation.AbstractValidator<ChatSessionModel>
{
    public ChatSessionModelValidator()
    {
        Include(new ChatSessionValidator());
        CustomValidation();
    }
