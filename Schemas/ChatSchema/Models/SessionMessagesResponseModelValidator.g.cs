...
public partial class SessionMessagesResponseModelValidator : FluentValidation.AbstractValidator<SessionMessagesResponseModel>
{
    public SessionMessagesResponseModelValidator()
    {
        Include(new SessionMessagesResponseValidator());
        CustomValidation();
    }
