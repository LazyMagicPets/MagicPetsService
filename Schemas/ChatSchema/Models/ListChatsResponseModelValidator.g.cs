...
public partial class ListChatsResponseModelValidator : FluentValidation.AbstractValidator<ListChatsResponseModel>
{
    public ListChatsResponseModelValidator()
    {
        Include(new ListChatsResponseValidator());
        CustomValidation();
    }
