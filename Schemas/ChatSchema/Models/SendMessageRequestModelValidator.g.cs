...
public partial class SendMessageRequestModelValidator : FluentValidation.AbstractValidator<SendMessageRequestModel>
{
    public SendMessageRequestModelValidator()
    {
        Include(new SendMessageRequestValidator());
        CustomValidation();
    }
