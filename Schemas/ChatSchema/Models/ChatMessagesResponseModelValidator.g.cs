...
public partial class ChatMessagesResponseModelValidator : FluentValidation.AbstractValidator<ChatMessagesResponseModel>
{
    public ChatMessagesResponseModelValidator()
    {
        Include(new ChatMessagesResponseValidator());
        CustomValidation();
    }
