...
public partial class CreateSessionResponseModelValidator : FluentValidation.AbstractValidator<CreateSessionResponseModel>
{
    public CreateSessionResponseModelValidator()
    {
        Include(new CreateSessionResponseValidator());
        CustomValidation();
    }
