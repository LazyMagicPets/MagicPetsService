...
public partial class CreateChatRequestModelValidator : FluentValidation.AbstractValidator<CreateChatRequestModel>
{
    public CreateChatRequestModelValidator()
    {
        Include(new CreateChatRequestValidator());
        CustomValidation();
    }
