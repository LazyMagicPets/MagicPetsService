...
public partial class ChatErrorModelValidator : FluentValidation.AbstractValidator<ChatErrorModel>
{
    public ChatErrorModelValidator()
    {
        Include(new ChatErrorValidator());
        CustomValidation();
    }
