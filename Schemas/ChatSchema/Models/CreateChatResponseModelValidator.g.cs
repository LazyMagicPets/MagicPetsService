...
public partial class CreateChatResponseModelValidator : FluentValidation.AbstractValidator<CreateChatResponseModel>
{
    public CreateChatResponseModelValidator()
    {
        Include(new CreateChatResponseValidator());
        CustomValidation();
    }
