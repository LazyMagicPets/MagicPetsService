...
public partial class SessionEventModelValidator : FluentValidation.AbstractValidator<SessionEventModel>
{
    public SessionEventModelValidator()
    {
        Include(new SessionEventValidator());
        CustomValidation();
    }
