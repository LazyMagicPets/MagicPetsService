...
public partial class UpdateChatRequestModelValidator : FluentValidation.AbstractValidator<UpdateChatRequestModel>
{
    public UpdateChatRequestModelValidator()
    {
        Include(new UpdateChatRequestValidator());
        CustomValidation();
    }
