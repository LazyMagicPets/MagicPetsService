...
public partial class ErrorEventModelValidator : FluentValidation.AbstractValidator<ErrorEventModel>
{
    public ErrorEventModelValidator()
    {
        Include(new ErrorEventValidator());
        CustomValidation();
    }
